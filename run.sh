...
function install {
    ...
    python -m pip install cookiecutter pytest pytest-xdist pre-commit
}
...
function generate-project {
    ...
    git add --all
    git branch -M main
    git commit -m "feat: generated sample project with python course"
}
...
EOF
    ...
    gh pr create \
        ...
        --body "This PR was generated by cookiecutter" \
        --base main \
